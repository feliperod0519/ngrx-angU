...
export const selectAllCourses = createSelector(selectCoursesState, 
                                               fromCourses.selectAll)

export const selectBeginnersCourses = createSelector(selectAllCourses,
...
export const areCoursesLoaded = createSelector(selectCoursesState,
